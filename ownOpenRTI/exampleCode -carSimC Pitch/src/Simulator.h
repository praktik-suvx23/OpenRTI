...
private:
    ...
    mutable std::mutex _simLoopMutex;
    mutable std::mutex _timeScaleFactorMutex;
    mutable std::mutex _simulatingMutex;
    mutable std::mutex _scenarioMutex;
    mutable std::mutex _carsMutex;
