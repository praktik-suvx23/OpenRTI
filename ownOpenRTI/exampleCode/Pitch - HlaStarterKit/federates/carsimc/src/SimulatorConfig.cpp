...
SimulatorConfig::SimulatorConfig(const string& file) : Properties(file) {}
...
string SimulatorConfig::getScenarioDir() const
{
    return StringUtils::wstr2str(getProperty(L"ScenarioDir"));
}

string SimulatorConfig::getCarsDir() const
{
  return StringUtils::wstr2str(getProperty(L"CarsDir"));
}
