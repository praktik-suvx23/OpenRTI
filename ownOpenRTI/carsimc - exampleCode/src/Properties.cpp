...
Properties::Properties(const string& file) : _comment(L"//"), _delimiter(L"="), _failedToLoad(false)
{
    parseConfig(file);
}

Properties::Properties(const string& file, const wstring& comment, const wstring& delimiter) : _comment(comment), _delimiter(delimiter), _failedToLoad(false)
{
    parseConfig(file);
}
...
void Properties::parseConfig(const string& fileName)
{
    string line;
